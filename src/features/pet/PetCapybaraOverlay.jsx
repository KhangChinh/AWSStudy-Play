...
const PetCapybaraOverlay = ({ equippedPet }) => {
  ...
  const pet = React.useMemo(() => {
    ...
    const allAnims = {
      ...
      Idle: { file: dbPet.assets?.idle_happy, frames: 6, speed: 150 },
      Walk: { file: dbPet.assets?.walk_right || dbPet.assets?.walkright, frames: 6, speed: 100 },
      Run: { file: dbPet.assets?.walk_right || dbPet.assets?.walkright, frames: 6, speed: 100 },
      Sleep: { file: dbPet.assets?.sleep_right || dbPet.assets?.sleepright, frames: 7, speed: 200 },
      Hurt: { file: dbPet.assets?.idle_happy, frames: 6, speed: 150 },
      Death: { file: dbPet.assets?.idle_happy, frames: 6, speed: 150, loop: false }
    };
...
export default PetCapybaraOverlay;