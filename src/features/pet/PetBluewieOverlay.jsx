...
const PetBluewieOverlay = ({ equippedPet }) => {
  ...
  const pet = React.useMemo(() => {
    ...
    const allAnims = {
      ...
      Idle: { file: dbPet.assets?.idle, frames: 4, speed: 150 },
      Walk: { file: dbPet.assets?.walk, frames: 8, speed: 100 },
      Run: { file: dbPet.assets?.run, frames: 6, speed: 100 },
      Hurt: { file: dbPet.assets?.damage, frames: 4, speed: 200 },
      Death: { file: dbPet.assets?.die, frames: 8, speed: 150, loop: false },
      Jump: { file: dbPet.assets?.jump, frames: 6, speed: 150 },
      Happy: { file: dbPet.assets?.happy, frames: 10, speed: 150 }
    };
...
export default PetBluewieOverlay;