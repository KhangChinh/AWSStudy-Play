...
const PetCatOverlay = ({ equippedPet }) => {
  ...
  const pet = React.useMemo(() => {
    ...
    const allAnims = {
      ...
      Idle: { file: dbPet.assets?.idle, frames: 8, speed: 150 },
      Walk: { file: dbPet.assets?.run, frames: 10, speed: 100 },
      Run: { file: dbPet.assets?.run, frames: 10, speed: 100 },
      Hurt: { file: dbPet.assets?.fall, frames: 4, speed: 200 },
      Death: { file: dbPet.assets?.fall, frames: 4, speed: 150, loop: false },
