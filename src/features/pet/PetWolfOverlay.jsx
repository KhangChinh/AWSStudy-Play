...
const PetWolfOverlay = ({ equippedPet }) => {
  ...
  const pet = React.useMemo(() => {
    ...
    const allAnims = {
      ...
      Idle: { file: dbPet.assets?.idle, frames: 6, speed: 150 },
      Walk: { file: dbPet.assets?.run, frames: 5, speed: 100 },
      Run: { file: dbPet.assets?.run, frames: 5, speed: 100 },
      Hurt: { file: dbPet.assets?.fall, frames: 7, speed: 200 },
      Death: { file: dbPet.assets?.fall, frames: 7, speed: 150, loop: false },
      Jump: { file: dbPet.assets?.jump, frames: 7, speed: 150 }
    };
